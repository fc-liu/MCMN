...
# na_prompt='none of the above'
# Train model 
CUDA_VISIBLE_DEVICES=$cuda python train.py --na_rate $nota --bert_model $bert_name --load_ckpt $pretrain_ckpt --dropout_keep_prob $dropout --learning_rate $learn_rate --N $N_num --save_ckpt $ckpt_name --batch_size 1
