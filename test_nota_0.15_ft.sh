...
# Train model 
CUDA_VISIBLE_DEVICES=$cuda python train.py --nota_epoch $epoch --na_rate $nota --bert_model $bert_name --dropout_keep_prob $dropout --learning_rate $learn_rate --N $N_num --save_ckpt $ckpt_name --batch_size 1
