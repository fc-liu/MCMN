...
from dataloader.pretrain_data_loader_nota import get_pretrain_laoder, BertEMDataset
...
load_ckpt_file_path = "./checkpoint/pretrain_nota/{}".format(FLAGS.load_ckpt)
save_ckpt_file_path="./checkpoint/pretrain_nota/{}".format(FLAGS.save_ckpt)
print("#######################################")
